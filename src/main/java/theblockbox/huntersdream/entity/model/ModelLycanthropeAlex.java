...
/**
 * LycanthropeAlex - VampireRedEye Created using Tabula 7.0.0
 */
public class ModelLycanthropeAlex extends ModelBase {
	...
	public ModelLycanthropeAlex() {
		...
		ModelLycanthropeAlex.setRotateAngle(this.tail, -0.7853981633974483F, 0.0F, 0.0F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.armr2, -0.3490658503988659F, 0.0F, 0.0F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.arml2, -0.3490658503988659F, 0.0F, 0.0F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.mane, 0.17453292519943295F, 0.0F, 0.0F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.arml, 0.0F, 0.0F, -0.05235987755982988F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.legl2, 1.0016444577195458F, 0.0F, 0.0F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.legr3, 0.3490658503988659F, 0.0F, 0.0F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.tail_1, 0.03490658503988659F, 0.0F, 0.0F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.furarml, -0.3141592653589793F, 0.0F, 0.0F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.footr, 0.3490658503988659F, 0.0F, 0.0F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.armr, 0.0F, 0.0F, 0.05235987755982988F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.furfl, 0.0F, 0.22689280275926282F, 0.0F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.tail2, -0.3490658503988659F, 0.0F, 0.0F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.footl, 0.3490658503988659F, 0.0F, 0.0F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.legl, -0.3490658503988659F, 0.0F, 0.0F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.legr2, 1.0016444577195458F, 0.0F, 0.0F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.furft, 0.0F, -0.19198621771937624F, 1.5707963267948966F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.earr, -1.0471975511965976F, -0.6108652381980153F, 0.2792526803190927F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.furbodyb, 0.4363323129985824F, 0.0F, 0.0F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.legr, -0.3490658503988659F, 0.0F, 0.0F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.furfr, 0.0F, -0.22689280275926282F, 0.0F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.furbodyb2, 0.2617993877991494F, 0.0F, 0.0F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.earl, -1.0471975511965976F, 0.6108652381980153F, -0.2792526803190927F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.legl3, 0.3490658503988659F, 0.0F, 0.0F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.furfb, 0.0F, -1.3089969389957472F, -1.5707963267948966F);
		...
		ModelLycanthropeAlex.setRotateAngle(this.furarmr, -0.3141592653589793F, 0.0F, 0.0F);
