...
public class ModelWerewolfAlex extends ModelWerewolf {
    public ModelWerewolfAlex() {
        ...
        this.legl2 = new ModelRenderer(this, 32, 48);
        ...
        this.bodyfurb.addBox(-4.5F, 0.0F, -1.0F, 9, 10, 3, 0.0F);
        ModelWerewolf.setRotateAngle(this.bodyfurb, 0.17453292519943295F, 0.0F, 0.0F);
        this.snout2 = new ModelRenderer(this, 48, 4);
        this.snout2.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.snout2.addBox(-1.5F, -6.0F, -6.0F, 3, 3, 5, 0.0F);
        ModelWerewolf.setRotateAngle(this.snout2, 0.3490658503988659F, 0.0F, 0.0F);
        this.earr3 = new ModelRenderer(this, 0, 0);
        this.earr3.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.earr3.addBox(-3.9F, -1.0F, 8.5F, 1, 1, 1, 0.0F);
        ModelWerewolf.setRotateAngle(this.earr3, 0.17453292519943295F, 0.0F, 0.0F);
        this.arml2 = new ModelRenderer(this, 40, 26);
        this.arml2.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.arml2.addBox(0.5F, 1.0F, -0.5F, 0, 10, 6, 0.0F);
        this.earl2 = new ModelRenderer(this, 0, 4);
        this.earl2.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.earl2.addBox(3.0F, -2.8F, 7.4F, 1, 2, 1, 0.0F);
        ModelWerewolf.setRotateAngle(this.earl2, 0.17453292519943295F, 0.0F, 0.0F);
        ...
        ModelWerewolf.setRotateAngle(this.bipedRightArm, 0.0F, 0.0F, 0.10000736613927509F);
        this.earl = new ModelRenderer(this, 36, 0);
        this.earl.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.earl.addBox(3.2F, -4.5F, 1.2F, 1, 3, 6, 0.0F);
        ModelWerewolf.setRotateAngle(this.earl, 0.7853981633974483F, 0.2617993877991494F, 0.0F);
        ...
        ModelWerewolf.setRotateAngle(this.bipedLeftArm, 0.0F, 0.0F, -0.10000736613927509F);
        ...
        this.tail2 = new ModelRenderer(this, 16, 52);
        this.tail2.setRotationPoint(0.0F, 0.0F, 3.0F);
        this.tail2.addBox(-2.0F, -2.0F, -0.8F, 4, 4, 8, 0.0F);
        ModelWerewolf.setRotateAngle(this.tail2, -0.3490658503988659F, 0.0F, 0.0F);
        this.earr = new ModelRenderer(this, 36, 0);
        this.earr.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.earr.addBox(-4.2F, -4.5F, 1.2F, 1, 3, 6, 0.0F);
        ModelWerewolf.setRotateAngle(this.earr, 0.7853981633974483F, -0.2617993877991494F, 0.0F);
        this.bipedHead = new ModelRenderer(this, 0, 0);
        this.bipedHead.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.bipedHead.addBox(-4.0F, -8.0F, -4.0F, 8, 8, 8, 0.0F);
        this.snout = new ModelRenderer(this, 24, 0);
        this.snout.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.snout.addBox(-2.0F, -3.2F, -7.0F, 4, 3, 3, 0.0F);
        ...
        this.earl3 = new ModelRenderer(this, 0, 0);
        this.earl3.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.earl3.addBox(2.9F, -1.0F, 8.5F, 1, 1, 1, 0.0F);
        ModelWerewolf.setRotateAngle(this.earl3, 0.17453292519943295F, 0.0F, 0.0F);
        this.armr2 = new ModelRenderer(this, 40, 26);
        this.armr2.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.armr2.addBox(-0.5F, 1.0F, -0.5F, 0, 10, 6, 0.0F);
        ...
        this.earr2 = new ModelRenderer(this, 0, 4);
        this.earr2.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.earr2.addBox(-4.0F, -2.8F, 7.4F, 1, 2, 1, 0.0F);
        ModelWerewolf.setRotateAngle(this.earr2, 0.17453292519943295F, 0.0F, 0.0F);
        this.facefurl = new ModelRenderer(this, 52, 28);
        this.facefurl.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.facefurl.addBox(4.5F, -6.0F, 0.5F, 0, 8, 4, 0.0F);
        ...
        this.tail3 = new ModelRenderer(this, 32, 9);
        this.tail3.setRotationPoint(0.0F, 0.4F, 5.5F);
        this.tail3.addBox(-1.5F, -1.8F, 0.0F, 3, 3, 4, 0.0F);
        ModelWerewolf.setRotateAngle(this.tail3, 0.03490658503988659F, 0.0F, 0.0F);
