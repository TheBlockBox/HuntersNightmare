 ...
 */
public class ModelLycanthropeQuadruped extends ModelBase {
	...
	public ModelLycanthropeQuadruped() {
		...
		this.arml.setRotationPoint(4.8F, 4.0F, -4.0F);
		this.arml.addBox(0.0F, -1.5F, -2.0F, 4, 10, 4, 0.0F);
		setRotateAngle(arml, 0.4363323129985824F, 0.0F, 0.0F);
		...
		setRotateAngle(bodyfur1, -1.2217304763960306F, 0.0F, 0.0F);
		...
		setRotateAngle(footl, 0.5235987755982988F, 0.0F, 0.0F);
		...
		setRotateAngle(armrfur1, 0.8726646259971648F, 0.0F, 0.0F);
		...
		setRotateAngle(tail, -0.593411945678072F, 0.0F, 0.0F);
		...
		setRotateAngle(handr, -0.4363323129985824F, 0.0F, 0.0F);
		...
		setRotateAngle(legl3, 0.5235987755982988F, 0.0F, 0.0F);
		...
		setRotateAngle(body2, -0.13962634015954636F, 0.0F, 0.0F);
		...
		setRotateAngle(handl, -0.4363323129985824F, 0.0F, 0.0F);
		...
		setRotateAngle(footr, 0.5235987755982988F, 0.0F, 0.0F);
		...
		setRotateAngle(armlfur1, 0.8726646259971648F, 0.0F, 0.0F);
		...
		setRotateAngle(body, 1.48352986419518F, 0.0F, 0.0F);
		...
		setRotateAngle(arml2, 0.8726646259971648F, 0.0F, 0.0F);
		...
		setRotateAngle(bodyfur2, -1.48352986419518F, 0.0F, 0.0F);
		...
		setRotateAngle(legr3, 0.5235987755982988F, 0.0F, 0.0F);
		...
		setRotateAngle(headfurl, -0.27314402793711257F, -0.5462880558742251F, 0.0F);
		...
		setRotateAngle(tail3, -0.2792526803190927F, 0.0F, 0.0F);
		...
		setRotateAngle(headfurr, -0.27314402793711257F, 0.5462880558742251F, 0.0F);
		...
		this.armr.setRotationPoint(-4.8F, 4.0F, -4.0F);
		this.armr.addBox(-4.0F, -1.5F, -2.0F, 4, 10, 4, 0.0F);
		setRotateAngle(armr, 0.4363323129985824F, 0.0F, 0.0F);
		...
		setRotateAngle(armr2, 0.8726646259971648F, 0.0F, 0.0F);
		...
		this.legr.setRotationPoint(-4.0F, 4.6F, 8.0F);
		this.legr.addBox(-2.0F, -2.0F, -3.0F, 4, 10, 6, 0.0F);
		setRotateAngle(legr, -0.5235987755982988F, 0.0F, 0.0F);
		...
		setRotateAngle(tail4, -0.13962634015954636F, 0.0F, 0.0F);
		...
		this.legl.setRotationPoint(4.0F, 4.6F, 8.0F);
		this.legl.addBox(-2.0F, -2.0F, -3.0F, 4, 10, 6, 0.0F);
		setRotateAngle(legl, -0.5235987755982988F, 0.0F, 0.0F);
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
		...
		this.arml.rotateAngleX = (MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount) / 2F;
		this.armr.rotateAngleX = (MathHelper.cos(limbSwing * 0.6662F + (float) Math.PI) * 1.4F * limbSwingAmount) / 2F;
		this.legl.rotateAngleX = (MathHelper.cos(limbSwing * 0.6662F + (float) Math.PI) * 1.4F * limbSwingAmount) / 2F;
		this.legr.rotateAngleX = (MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount) / 2F;
	}
}