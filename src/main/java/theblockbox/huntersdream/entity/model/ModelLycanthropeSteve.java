 ...
 */
public class ModelLycanthropeSteve extends ModelBase {
	...
	public ModelLycanthropeSteve() {
		...
		ModelLycanthropeSteve.setRotateAngle(this.legr, -0.3490658503988659F, 0.0F, 0.0F);
		...
		ModelLycanthropeSteve.setRotateAngle(this.legl3, 0.3490658503988659F, 0.0F, 0.0F);
		...
		ModelLycanthropeSteve.setRotateAngle(this.tail, -0.7853981633974483F, 0.0F, 0.0F);
		...
		ModelLycanthropeSteve.setRotateAngle(this.legr3, 0.3490658503988659F, 0.0F, 0.0F);
		...
		ModelLycanthropeSteve.setRotateAngle(this.furft, 0.0F, -0.19198621771937624F, 1.5707963267948966F);
		...
		ModelLycanthropeSteve.setRotateAngle(this.legl2, 1.0016444577195458F, 0.0F, 0.0F);
		...
		ModelLycanthropeSteve.setRotateAngle(this.furfr, 0.0F, -0.22689280275926282F, 0.0F);
		...
		ModelLycanthropeSteve.setRotateAngle(this.furarmr, -0.3141592653589793F, 0.0F, 0.0F);
		...
		ModelLycanthropeSteve.setRotateAngle(this.legl, -0.3490658503988659F, 0.0F, 0.0F);
		...
		ModelLycanthropeSteve.setRotateAngle(this.earl, -1.0471975511965976F, 0.6108652381980153F,
				-0.2792526803190927F);
		...
		ModelLycanthropeSteve.setRotateAngle(this.tail_1, 0.03490658503988659F, 0.0F, 0.0F);
		...
		ModelLycanthropeSteve.setRotateAngle(this.furbodyb2, 0.2617993877991494F, 0.0F, 0.0F);
		...
		ModelLycanthropeSteve.setRotateAngle(this.armr2, -0.3490658503988659F, 0.0F, 0.0F);
		...
		this.armr.setRotationPoint(-4.0F, -3.5F, -1.0F);
		this.armr.addBox(-4.0F, -2.0F, -2.0F, 4, 8, 4, 0.0F);
		ModelLycanthropeSteve.setRotateAngle(this.armr, 0.0F, 0.0F, 0.05235987755982988F);
		this.mane = new ModelRenderer(this, 0, 32);
		this.mane.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.mane.addBox(-4.5F, -7.0F, -4.5F, 9, 8, 9, 0.0F);
		ModelLycanthropeSteve.setRotateAngle(this.mane, 0.17453292519943295F, 0.0F, 0.0F);
		...
		ModelLycanthropeSteve.setRotateAngle(this.furfl, 0.0F, 0.22689280275926282F, 0.0F);
		...
		ModelLycanthropeSteve.setRotateAngle(this.furbodyb, 0.4363323129985824F, 0.0F, 0.0F);
		...
		ModelLycanthropeSteve.setRotateAngle(this.legr2, 1.0016444577195458F, 0.0F, 0.0F);
		...
		ModelLycanthropeSteve.setRotateAngle(this.earr, -1.0471975511965976F, -0.6108652381980153F,
				0.2792526803190927F);
		...
		ModelLycanthropeSteve.setRotateAngle(this.tail2, -0.3490658503988659F, 0.0F, 0.0F);
		...
		ModelLycanthropeSteve.setRotateAngle(this.furfb, 0.0F, -1.3089969389957472F, -1.5707963267948966F);
		...
		ModelLycanthropeSteve.setRotateAngle(this.footl, 0.3490658503988659F, 0.0F, 0.0F);
		...
		ModelLycanthropeSteve.setRotateAngle(this.arml2, -0.3490658503988659F, 0.0F, 0.0F);
		...
		this.arml.setRotationPoint(4.0F, -3.5F, -1.0F);
		this.arml.addBox(0.0F, -2.0F, -2.0F, 4, 8, 4, 0.0F);
		ModelLycanthropeSteve.setRotateAngle(this.arml, 0.0F, 0.0F, -0.05235987755982988F);
		...
		ModelLycanthropeSteve.setRotateAngle(this.footr, 0.3490658503988659F, 0.0F, 0.0F);
		...
		ModelLycanthropeSteve.setRotateAngle(this.furarml, -0.3141592653589793F, 0.0F, 0.0F);
