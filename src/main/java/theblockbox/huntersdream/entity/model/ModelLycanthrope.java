...
public class ModelLycanthrope extends ModelBase {
	...
	public ModelLycanthrope() {
		...
		this.armr.addBox(-4.0F, -2.0F, -2.0F, 4, 18, 4, 0.0F);
		...
		this.snout.addBox(-2.0F, -4.1F, -7.0F, 4, 4, 3, 0.0F);
		...
		this.legl2.addBox(-2.0F, 4.0F, 2.0F, 4, 12, 4, 0.0F);
		...
		this.legr2.addBox(-2.0F, 4.0F, 2.0F, 4, 12, 4, 0.0F);
		...
		this.arml.addBox(0.0F, -2.0F, -2.0F, 4, 18, 4, 0.0F);
