...
import huntersdream.world.gen.CustomEntitySpawn;
import net.minecraft.entity.EnumCreatureType;

public class EntitySpawnInit {
	public static final ArrayList<CustomEntitySpawn> CUSTOM_ENTITY_SPAWNS = new ArrayList<>();

	public static final CustomEntitySpawn SPAWN_VILLAGER_WEREWOLF = new CustomEntitySpawn(EntityVillagerWerewolf.class,
